...
#This should actually be the real RPA, but making it the actual number made everyone's stat negative, because only like 3-5 guys from each team hit a disproportionate amount of the runs
...
both_pitching_after <- both_pitching %>%
  ...
  select(No, Name, Team, G, GS, IP, W, L, ERA, FIP, `WH/IP` = WHIP, MABL = pitchWAR_mabl, NMTBL = pitchWAR_nmtbl, pitchWAR = total_pitchWAR)
