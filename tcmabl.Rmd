...
mabl_games_played <- 10
mabl_total_games <- 22
mabl_teams <- 14
mabl_opponent_name <- "Expos"
...
nmtbl_games_played <- 7 #This is down one for us until we make up the Stars game. I'm counting North Stars even though the stats aren't in.
nmtbl_total_games <- 15
nmtbl_teams <- 16
nmtbl_opponent_name <- "Banditos"
...
mabl_pitch <- mabl_scrape_pitching %>%
  ...
  mutate(
    across(.cols = c(G, GS, CG, SHO, W, L, SV, SVO, BF, H, R, ER, HR, HBP, BB,# IBB, 
                     SO, SacF, #SacB, 
                     BK, #which will come back whenever someone records one
                     B, S, 
